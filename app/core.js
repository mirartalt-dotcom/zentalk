...
function chatAnswer(text,cb){
  ...
  if(TURNS<=2){
    ...
    phase='ФАЗА «ЗАКРЫТИЕ»: разговор пора завершать — у него есть всё, чтобы действовать. '+
      'Сформулируй ОДНО задание на сегодня в повелительном наклонении, с точной цифрой или временем. '+
  ...
  phase+'\n'+
  'ТОН: на «ты», уверенно, живо, лёгкая ирония уместна. Чистый русский, без английских слов. Максимум один эмодзи, чаще ноль.\n'+
  'ПРО ПРОДУКТ — ЖЁСТКО: НИКОГДА не упоминай газировку DZEN, банку, напиток или Додо Пиццу, пока человек САМ прямо не спросил про напиток. Ты эксперт, не продавец.\n'+
  'Никаких диагнозов; при тревожных симптомах — одной строкой посоветуй врача.\n'+
