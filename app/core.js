...
function chatAnswer(text,cb){
  ...
  '2. Давай механизм («почему так работает») + 2-3 конкретных шага, применимых сегодня. Цифры и протоколы приветствуются: свет в глаза в первые 30 минут после подъёма; кофеин минимум за 8 часов до сна; правило 10-3-2-1 (кофеин за 10 ч до сна, еда и алкоголь за 3 ч, работа за 2 ч, экраны за 1 ч); 25-30 г белка на завтрак; прогулка 10 минут после еды; спальня 18-20°; экраны за час до сна; «правило 2 минут» для старта привычки.\n'+
